...
bar_plot(world_data1, 'Urban population growth (annual %)', 'Countries','Year')

# Calling line plot function with indicator as population growth
line_plot(world_data1, 'Urban population growth (annual %)', 'Countries', 'Year')
...
bar_plot(world_data1, 'Population, total', 'countries','Year')

# Calling line plot function with indicator as total population 
line_plot(world_data1, 'Population, total', 'countries','Year')
